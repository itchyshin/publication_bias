...
@TO-DO: problem in the below chunk when knitting to html (`object obsID not found`), not sure why because the chunks run fine one-byone.
```{r}
# lnRR
...
```{r fig.align = "center",fig.caption=}
par(mfrow = c(1, 2))
